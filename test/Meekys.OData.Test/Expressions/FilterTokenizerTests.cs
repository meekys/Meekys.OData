...
namespace Meekys.OData.Tests.Expressions
{
    public class FilterTokenizerTests
    {
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("a      b").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("a(b)c").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("'Test'").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("Test 'Test' Test").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("'Testing ''quotes'' and (brackets) in strings'").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("Test prefix'value' Test").Tokens;
        ...
        {
            // Arrange
            var tokens = new FilterTokenizer("Test 'value'trailing Test").Tokens;
